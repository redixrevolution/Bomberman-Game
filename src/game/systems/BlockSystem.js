...
export class BlockSystem {
    ...
    constructor(updateStageMapAt, getSageCollisionTileAt, addPowerup) {
        this.updateStageMapAt = updateStageMapAt;
        this.getSageCollisionTileAt = getSageCollisionTileAt;
    ...
    isBlockAllowedAt(cell) {
        ...
        if (isStartZone || this.getSageCollisionTileAt(cell) !== CollisionTile.EMPTY) return false;
