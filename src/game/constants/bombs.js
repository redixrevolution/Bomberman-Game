...
export const BASE_FRAME = 187; //first frame of the fuse bomb
...
export const FUSE_TIMER = 3000; //300 millisec timer

export const BOMB_FRAME_DELAY = 16 * FRAME_TIME;
export const BOMB_EXPLODE_DELAY = 8 * FRAME_TIME;
export const BOMB_ANIMATION = [0, 1, 2, 1]; //this is the bomb animation from the pictures.
